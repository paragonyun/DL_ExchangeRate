...
class Trainer:
    ...
    def doit(self):
        if self.version == "e" or self.version == "a":
            ...
            for epoch in range(1, self.epoches + 1):
                ...
                if running_loss < best_loss:
                    ...
                    if self.version == "e":
                        torch.save(self.model.state_dict(), "./EVENT_BEST_MODEL.pth")
                    elif self.version == "a":
                        torch.save(self.model.state_dict(), "./ATTENTION_BEST_MODEL.pth")
            ...
            for epoch in range(1, self.epoches + 1):
                ...
                if running_loss < best_loss:
                    print("🚩 Saving Best Model...")
                    torch.save(self.model.state_dict(), "./NORMAL_BEST_MODEL.pth")
                    best_loss = running_loss
